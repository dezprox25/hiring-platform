...
const feedback_entity_1 = require("../../reports/entities/feedback.entity");
let User = class User {
};
exports.User = User;
__decorate([
...
__decorate([
    (0, typeorm_1.Column)({
        ...
        default: role_enum_1.Role.CANDIDATE,
    }),
    __metadata("design:type", String)
...
__decorate([
    (0, typeorm_1.OneToOne)(() => candidate_entity_1.Candidate, (c) => c.user),
    __metadata("design:type", candidate_entity_1.Candidate)
], User.prototype, "candidate", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => feedback_entity_1.Feedback, (f) => f.manager),
